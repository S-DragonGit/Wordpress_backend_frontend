const Header = (props: {
  ...
  return (
    <header className="sticky top-0 z-999 flex w-full md:drop-shadow-0 drop-shadow-1  bg-white">
      <div className="flex flex-grow items-center justify-between py-4 md:py-0 px-4 md:shadow-0 shadow-2 md:px-6 2xl:px-11">
