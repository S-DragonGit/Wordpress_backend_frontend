  ...
  return (
    <div className="grid gap-5 smd:grid-cols-2 grid-cols-1 smd:mt-10 smd:ml-10">
      ...
      <div className="smd:border-l border-gray-border pl-5">
        ...
        <div className="flex items-center mt-8 w-4/5">
          <button className="p-2 px-4 rounded-md bg-primary-light border text-sm border-primary text-primary m-auto mt-10">
            Send
          </button>
        </div>
      </div>
